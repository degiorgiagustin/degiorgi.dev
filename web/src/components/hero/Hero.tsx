  ...
  return (
    <section className="flex min-h-svh flex-col px-4 pt-16 pb-8 text-center">
      <div className="flex flex-1 flex-col items-center justify-center gap-6 sm:gap-8">
        ...
        <p className="leading-body text-text-2 max-w-2xl text-base text-pretty">
          {hero.subline}
        </p>
        ...
        <div
          aria-hidden
          data-console-slot
          className="min-h-32 w-full max-w-2xl sm:min-h-48 lg:min-h-56"
        />
      </div>
      ...
      <a
        href="#journey"
        className="text-text-3 hover:text-text-2 tracking-label mt-6 inline-flex min-h-11 items-center justify-center gap-2 self-center font-mono text-xs uppercase"
      >
